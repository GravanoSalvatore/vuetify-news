<template lang="">
     <div class="pt-16">
            <h2 class="text-h4 font-weight-bold pb-4"></h2>

            <v-row>
              <v-col v-for="item in articles" :key="i"  lg="4">
                <v-card dark flat>
                  <v-img
                      :aspect-ratio="16 / 9"
                  ...
                  >
                    ...
                    >
                      <v-card-text>
                        <!-- <v-btn style="background-color:black">BUSINESS</v-btn> -->
                      </v-card-text>
                      ...
                      <v-card-text>
                        ...
                        >
                        <a style="color:white" :href="item.url" target="_blank"> {{item.title}}</a>
                        </div>

                        <div class="d-flex align-center">
                         

                          <div class="pl-2"> <div class="pl-2">{{ formatDateTime(item.publishedAt) }}</div></div>
                        </div>
                      </v-card-text>
                    </div>
                  </v-img>
                  ...
                  >
                    ...
                    >
                      <v-card-text>
                        <v-btn style="color:black">BUSINESS</v-btn>
                      </v-card-text>
