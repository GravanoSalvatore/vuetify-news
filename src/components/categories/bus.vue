      ...
      <v-row>
        <v-col cols="12" lg="12" xl="8">
          <div>
            <div>
              <div>
                <h2 class="text-h4 font-weight-bold"><router-link to="Business">BUSINESS</router-link></h2>
                  ...
                  >
                    <div>
                      ...
                      >
                        ...
                        >
                          <!-- <v-card-text>
                            <v-btn style="font-size:10px" color="accent">BUSINESS</v-btn>
                          </v-card-text> -->
                        </v-img>
                        <v-img
                          v-else
                          src="https://www.shaikhandcoaccountants.com/wp-content/uploads/2021/11/business-news-2-shaikh.jpg"
                          :aspect-ratio="16 / 9"
                          gradient="to top, rgba(25,32,72,.4), rgba(25,32,72,.0)"
                          height="200px"
                          class="elevation-2"
