      ...
      <v-row>
        <v-col cols="12" lg="12" xl="8">
          <div>
            <div>
              <div>
                <h2 class="text-h4 font-weight-bold"><router-link to="Science">SCIENCE</router-link></h2>
                  ...
                  >
                    <div>
                      ...
                      <v-img
                        ...
                        <v-img
                          v-else
                          src="https://thephysicist.in/wp-content/uploads/2021/09/Science-News.jpg.webp"
                          :aspect-ratio="16 / 9"
                          gradient="to top, rgba(25,32,72,.4), rgba(25,32,72,.0)"
                          height="200px"
                          class="elevation-2"
