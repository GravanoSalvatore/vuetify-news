    ...
    <v-row>
      <v-col cols="12" lg="12" xl="8">
        <div>
          <div>
            <div>
              <h2 class="text-h4 font-weight-bold"><router-link to="Sport">SPORT</router-link></h2>
                ...
                >
                  <div>
                    ...
                    <v-img
                      ...
                      >
                        <!-- <v-card-text>
                          <v-btn color="accent">SCIENCE</v-btn>
                        </v-card-text> -->
                      </v-img>
                      <v-img
                        v-else
                        src="https://sport.ec.europa.eu/sites/default/files/styles/eac_ratio_16_9_xl/public/sport-active-part-erasmus-plus-crop.jpg?h=5dabf909&itok=JM-JNmjy"
                        :aspect-ratio="16 / 9"
                        gradient="to top, rgba(25,32,72,.4), rgba(25,32,72,.0)"
                        height="200px"
                        class="elevation-2"
