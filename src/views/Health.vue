      ...
      <v-row>
        <v-col cols="12" lg="12" xl="8">
          <div>
            <div>
              <div>
                <h2 class="text-h4 font-weight-bold">HEALTH</h2>
                  ...
                  >
                    <div>
                      ...
                      <v-img
                        ...
                        >
                          <!-- <v-card-text>
                            <v-btn color="accent">HEALTH</v-btn>
                          </v-card-text> -->
                        </v-img>
                        <v-img
                          v-else
                          src="https://thumbs.dreamstime.com/t/health-news-broadcast-tv-title-graphic-health-news-graphic-main-title-videos-images-background-seamless-looping-video-140535000.jpg"
                          :aspect-ratio="16 / 9"
                          gradient="to top, rgba(25,32,72,.4), rgba(25,32,72,.0)"
                          height="200px"
                          class="elevation-2"
